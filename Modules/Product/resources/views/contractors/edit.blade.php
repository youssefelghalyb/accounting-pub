        ...
        [
            ...
            'fields' => [
                ...
                [
                    ...
                    'required' => false,
                    'value' => $contractor->secondary_email,
                    'grid' => 6,
                    'borderColor' => '#3b82f6'
                ],
                [
                ...
                [
                    ...
                    'required' => false,
                    'value' => $contractor->secondary_phone,
                    'grid' => 6,
                    'borderColor' => '#3b82f6'
                ]
            ]
...
<x-dashboard :pageTitle="__('product::contractor.edit_contractor')">
    <div class="max-w-5xl mx-auto">
        <nav class="mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }}">
                ...
                <li>
                    <span class="text-gray-900 font-medium">{{ $contractor->name }}</span>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-900">{{ __('product::contractor.edit_contractor') }}</h2>
            </div>

            <div class="p-6">
                <x-dashboard.packages.form-builder
                    :action="route('product.contractors.update', $contractor)"
                    method="POST"
