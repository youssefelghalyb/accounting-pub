            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'required' => false,
                        'value' => $book->contractorBook?->contractor_id,
                        'grid' => 6,
                        'borderColor' => '#f59e0b',
                    ...
                    [
                        ...
                        'required' => false,
                        'value' => $book->contractorBook?->percentage_basis,
                        'grid' => 6,
                        'borderColor' => '#f59e0b',
                        'options' => [
                    ...
                    [
                        ...
                        'required' => false,
                        'value' => $book->contractorBook?->profit_percentage,
                        'grid' => 4,
                        'borderColor' => '#f59e0b',
                    ],
                    [
                        ...
                        'required' => false,
                        'value' => $book->contractorBook?->contract_date?->format('Y-m-d'),
                        'grid' => 4,
                        'borderColor' => '#f59e0b',
                    ],
                    [
                        ...
                        'required' => false,
                        'value' => $book->contractorBook?->end_contract_date?->format('Y-m-d'),
                        'grid' => 4,
                        'borderColor' => '#f59e0b',
                    ],
                    [
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <nav class="mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 {{ app()->getLocale() == 'ar' ? 'space-x-reverse' : '' }}">
                ...
                <li>
                    <span class="text-gray-900 font-medium">{{ __('product::book.edit_book') }}</span>
                </li>
            </ol>
        </nav>
